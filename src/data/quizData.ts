...
const image = {
  ...
  portakal: "/images/oda_pencere/portakal.png",
  baharat: "/images/oda_pencere/baharat.png",
...
export const QUIZ_STEPS: QuizStep[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "gecesalonu", label: "Loş ve Sıcak Bir Salon", image: image.lounge, profile: ["Gourmand & Tatlı", "Amber & Reçineli"] },
    ],
  },
];
